...
int main(int argc, char **argv)
{
    ...
    if (childPid) {
	    printf("[Parent] Message1. This message is displayed by both parent and child\n");
    } else {
	    printf("[Child] Message1. This message is displayed by both parent and child\n");
    }
    ...
    if (childPid) {
	    printf("[Parent] Message2.  This message is displayed by both parent and child\n");
    } else {
        printf("[Child] Message2.  This message is displayed by both parent and child\n");
    }
